-- Inserción de datos en la tabla `families`
...
-- Inserción de datos en la tabla `types`
...
-- Inserción de datos en la tabla `animals`
-- Eliminando duplicados y usando un solo conjunto de datos
...
-- Asegúrate de que las tablas `roles` y `users` tengan la estructura correcta
